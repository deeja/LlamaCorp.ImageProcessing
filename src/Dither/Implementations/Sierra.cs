...
{
  [EnumLink(typeof(DitherAlgorithm), (int)DitherAlgorithm.Sierra3)]
  public class Sierra : IDither
  {
    public void PerformWork(Image image, Parameters parameters = null)
    {
      ...
      for (var x = 0; x < image.Width; x++)
      {
        for (var y = 0; y < image.Height; y++)
        {
          ...
          var errorMultiplier = ((double)error / 32.0);

          // x + 1, y
          image.SetPixelError(x + 1, y, errorMultiplier * 5);
          ...
          // x, y + 1
          image.SetPixelError(x, y + 1, errorMultiplier * 5);
          ...
          // x, y + 2
          image.SetPixelError(x, y + 2, errorMultiplier * 3);
